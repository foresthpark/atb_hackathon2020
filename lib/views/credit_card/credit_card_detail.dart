import 'package:atb_hackathon/src/models/bank_card_model.dart';
import 'package:atb_hackathon/src/widgets/bank_card/bank_card.dart';
...
class CreditCardDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Color(0xFF009CDE),
          elevation: 0,
